...
export async function handleFindObjectById(req: FastifyRequest, res: FastifyReply) {
  ...
  const command = new GetObjectCommand({ Bucket: process.env.R2_BUCKET, Key: object.imageKey! })
